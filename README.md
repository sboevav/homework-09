...
Судя по разным статьям, кажется, сборка ядра в контейнере возможна, но все-таки это большой гемор. Еще одна ссылка.  
https://fooobar.com/questions/17011924/is-it-possible-to-use-a-kernel-module-built-from-within-docker  
